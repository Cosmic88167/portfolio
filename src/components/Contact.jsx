    ...
    emailjs
      .send(
        ...
        "template_9rffokc",
        {
          ...
          to_email: "manishtiwari88167@gmail.com",
      ...
      >
        ...
        >
          <label htmlFor="" className="flex flex-col">
            <span className="text-white-fon-medium mb-4">Your Name</span>
            <input
              type="text"
              name="name"
              value={form.name}
          ...
          <label htmlFor="" className="flex flex-col">
            <span className="text-white-fon-medium mb-4">Your Message</span>
            <textarea
              rows={7}
              name="message"
              value={form.message}
          ...
          w-fit font-bold text-white shadow-md
