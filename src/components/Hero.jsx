      ...
      >
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} text-white-100`}>
            🚀 Welcome! I&apos;m a results-driven Full Stack Web 
            Developer & ML expert  <br className="sm:block hidden" />specializing in crafting seamless, user-centric experiences.
