    ...
    <>
      ...
      <div className="max-w-8xl flex flex-wrap gap-14  ">
        ...
        >
          ...
          <span className="text-[#915eff]">Manish Tiwari</span>, a proficient
          ...
          that not only look stunning but also provide an exceptional user experience 
          with machine learning and AI I thrive on attention to detail and
